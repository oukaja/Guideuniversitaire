...
public class EtablissementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.listEtab);
        List<Etablissement> result = ((global) getApplication()).getDaoSession().getEtablissementDao()._queryUniversites_Etablissements(getIntent().getExtras().getLong("idU"));

        List<Map<String, String>> data = new ArrayList<Map<String, String>>();
        for (Etablissement item : result) {
